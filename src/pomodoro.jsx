    ...
    <div>
      <div className="main">
        ...
        <div className="status2">
          <div>{trackintervals<10? `0${trackintervals}`:{trackintervals}}&emsp;Complete sessions</div>
          <div>{trackintervals}/{intervals - 1}&emsp;Till long break</div>
        </div>
      </div>
